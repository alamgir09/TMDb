  ...
  return (
        <div className="container-fluid">
          ...
          <form className="formStyle" onSubmit={handleLoginForm}>
              ...
              <input className="form-control" type="text" id="username" value={username}  onChange={e => setUsername(e.target.value)} placeholder="Username" required/>
    				</div>
    				<div className="input-group mb-3 p-0">
          ...
          <p className="text-center pt-3" id="response">{fetchResponse}</p>
