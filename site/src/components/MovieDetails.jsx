    ...
    function MovieDetails() {
        ...
        const detailsApiUrl = "https://api.themoviedb.org/3/movie/" + id + "?api_key=b8f33277c38d4286ab9e30134ebf037e&language=en-US"
        const creditsApiUrl = "https://api.themoviedb.org/3/movie/" + id + "/credits?api_key=b8f33277c38d4286ab9e30134ebf037e&language=en-US"
            ...
            <div className="movie-details">
              ...
              <div className="movie-info">
                ...
                <div className="movie-meta">
                  <span className="release-date"><strong>{releaseDate}</strong></span>
                  <span className="rating"><strong>{rating}</strong></span>
                </div>
                <div ><strong> Director(s): </strong></div>
                <span className="director">{directors.join(', ')}</span>
                <div ><strong> Production Studio(s): </strong></div>
